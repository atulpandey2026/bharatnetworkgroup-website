...
const footerBrands = [
  ...
  { name: 'NetconX', href: '#' },
  { name: 'The Autonaut Media', href: 'https://theautonautmedia.com/' },
  { name: 'All About Campus', href: 'https://allaboutcampus.com/' },
  { name: 'Hoarding Dekho', href: 'https://hoardingdekho.com/' },
];
